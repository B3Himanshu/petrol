...
/**
 * Bunkered Breakdown Card Component
 * Displays Volume, Sales, and Profit for bunkered sites
 */
export const BunkeredBreakdownCard = ({ volume, sales, profit, loading, error }) => {
  ...
  return (
    <div className="relative bg-card rounded-xl sm:rounded-2xl border border-border shadow-sm overflow-hidden group">
      ...
      <div className="bg-gradient-to-r from-blue-500 to-blue-600 px-3 sm:px-4 py-2.5 sm:py-3 flex items-center gap-2">
        <Fuel className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
        <h3 className="text-sm sm:text-base font-bold text-white">Bunkered</h3>
      </div>
